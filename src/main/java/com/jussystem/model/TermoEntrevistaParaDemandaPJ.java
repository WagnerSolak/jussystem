...
@Entity
public class TermoEntrevistaParaDemandaPJ implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TermoEntrevistaParaDemandaPJ other = (TermoEntrevistaParaDemandaPJ) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	// Método usado para os relatórios
	@Transient
	public String getAcidenteTrabalhoFormatado() {

		if (acidenteTrabalho == "S") {
			return "Sim";
		}
		if (acidenteTrabalho == "N") {
			return "Não";
		}
		return "";
	}
