...
public class ProcuracaoAdJudiciasPF implements Serializable{
	...
	public ProcuracaoAdJudiciaPF guardar(ProcuracaoAdJudiciaPF procuracaoAdJudicia) {
		return manager.merge(procuracaoAdJudicia);
	}
	

	@SuppressWarnings("unchecked")
	public List<ProcuracaoAdJudiciaPF> filtradas(ProcuracaoAdJudiciaPFFilter filtro) {
        Session session = this.manager.unwrap(Session.class);
		
		Criteria criteria = session.createCriteria(ProcuracaoAdJudiciaPF.class)
	...
	public ProcuracaoAdJudiciaPF porId(Long id) {
		return manager.find(ProcuracaoAdJudiciaPF.class, id);
	}
