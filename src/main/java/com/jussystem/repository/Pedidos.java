...
import com.jussystem.model.vo.DataValor;
...
public class Pedidos implements Serializable{
	...
	public Map<Date, BigDecimal> valoresTotaisPorData(Integer numeroDeDias, Usuario criadoPor){
		...
		Criteria criteria = session.createCriteria(Pedido.class);
				...
				.add(Projections.sqlGroupProjection("date(dataCriacao) as data",
						"date(dataCriacao)", new String[] {"data"},
				...
				if(criadoPor != null) {
					criteria.add(Restrictions.eq("comprador", criadoPor));
				}
				...
				// from pedido where data_criacao >= :dataInicial and comprador_id = :criadoPor
